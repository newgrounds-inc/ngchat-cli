...
// emojiCatalog is every emoji shortname the composer can complete,
// with its glyph decoded from upstream's codepoints at generate time
// so the row renderer never parses hex.
